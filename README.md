...
By the end of this lab, you should able to 1) Create a route using the Express.js framework 2) Implement logic that allows you to accept data via a 'GET' request, and 3) Implement logic that responds back to the client and sends HTML and data.
